        ...
        <div className="max-w-4xl w-full relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mt-20 px-10">
                <div className="text-center group cursor-default">
                    <p className="text-4xl font-black text-slate-800 group-hover:text-orange-500 transition-colors">12</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2">Active Orders</p>
                </div>
                <div className="text-center md:border-l border-slate-200 group cursor-default">
                    <p className="text-4xl font-black text-slate-800 group-hover:text-orange-500 transition-colors">450</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2">SunPoints</p>
                </div>
                <div className="text-center md:border-l border-slate-200 group cursor-default">
                    <p className="text-4xl font-black text-slate-800 group-hover:text-orange-500 transition-colors">4</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2">Wishlist</p>
                </div>
                <div className="text-center md:border-l border-slate-200 group cursor-default">
                    <p className="text-4xl font-black text-slate-800 group-hover:text-orange-500 transition-colors">2</p>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2">Past Reviews</p>
                </div>
            </div>
        </div>
      </div>
